...
async function run() {
  ...
  const s = JSON.parse(setRes.asset.value).current;
  
  console.log('page_background_color:', s.page_background_color);
  console.log('color_palette:', JSON.stringify(s.color_palette, null, 2));
